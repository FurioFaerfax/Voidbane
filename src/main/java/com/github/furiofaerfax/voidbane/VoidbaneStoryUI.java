...
public class VoidbaneStoryUI extends BuilderActionBase {
    @Nonnull
    ...
    public Action build(@Nonnull BuilderSupport builderSupport) {
        return new VoidbaneShowDialog(this, builderSupport);
    }
    ...
    @Nonnull
    public VoidbaneStoryUI readConfig(@Nonnull JsonElement data) {
        this.requireAsset(data, "Shop", this.shopId, BarterShopExistsValidator.required(), BuilderDescriptorState.Stable, "The barter shop to open", (String)null);
