...
public class ActionOpenBarterShop2 extends ActionBase {
    @Nonnull
    protected final String shopId;

    public ActionOpenBarterShop2(@Nonnull BuilderActionOpenBarterShop2 builder, @Nonnull BuilderSupport support) {
        super(builder);
